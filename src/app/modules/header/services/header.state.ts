...
export class HeaderState {
  private readonly notifications_dropdown: BehaviorSubject<boolean> = new BehaviorSubject(false);
  private readonly book_interview_date_dropdown: BehaviorSubject<boolean> = new BehaviorSubject(false);
  private readonly menu_dropdown: BehaviorSubject<boolean> = new BehaviorSubject(false);
