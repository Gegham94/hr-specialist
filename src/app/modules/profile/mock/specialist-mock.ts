...
export const genders: ISearchableSelectData[] = [
...
export const employments: ISearchableSelectData[] = [
...
export const citizenShips: ISearchableSelectData[] = [
  { id: 0, value: "arm", displayName: "Резидент РФ" },
  { id: 1, value: "rus", displayName: "Нерезидент" },
];

export const specialistPosition: ISearchableSelectData[] = [
...
export const educations: ISearchableSelectData[] = [
  { id: 0, value: "full-time", displayName: "Очная" },
  { id: 1, value: "remote", displayName: "Заочная" },
];

export const faculties: ISearchableSelectData[] = [
