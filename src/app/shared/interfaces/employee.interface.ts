import { IEducationItem, IWorkExperience } from "src/app/modules/profile/interfaces/profile-form.interface";
import { ISearchableSelectData } from "./searchable-select-data.interface";
