...
import { FilterRecourseLocationCities } from "src/app/modules/profile/interfaces/filter-resource-list-city.model";
import { ISearchableSelectData } from "../../shared/interfaces/searchable-select-data.interface";
import { SearchTypeEnum } from "../../shared/interfaces/search-type.enum";
...
export class FilterComponent extends Unsubscribe implements OnInit, OnDestroy {
  ...
  public searchListProgrammingLanguages!: ISearchableSelectData[];
  ...
  public searchListFrameworks!: ISearchableSelectData[] | null;
    ...
    switch (type) {
      ...
      case this.selectTypeEnum.city: {
        this._employeeFacade
          .getCitiesByCountry(this.searchParams, this.companyFilterCountryControl.value)
          .pipe(takeUntil(this.ngUnsubscribe))
          .subscribe();
        this.companyFilterCityControl.setValue(null);
        break;
